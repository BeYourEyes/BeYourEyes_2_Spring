package com.dna.beyoureyes.onboarding
...
class f_Onboarding : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(number: Int): f_Onboarding {
            val fragment = f_Onboarding()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_f__onboarding, container, false)
        ...
        if (number == 1) {
            ...
            imageView.setImageResource(R.drawable.onboardingimage1)
